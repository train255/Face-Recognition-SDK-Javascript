...
function scaleResult(bbox, landmark, resize_param) {
  var size = bbox.shape[0];
...
async function predictPose(session, canvas_id, bbox, question) {
...
async function predictEye(session, canvas_id, landmark) {
  var img = cv.imread(canvas_id)
